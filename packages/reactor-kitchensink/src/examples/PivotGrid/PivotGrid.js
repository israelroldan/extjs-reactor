...
export default class PivotGridExample extends Component{
    ...
    render() {
        return (
            ...
            >
                <Toolbar docked="top">
                    <Button text="Show configurator" handler={() => this.grid.showConfigurator()}/>
                    <Button text="Expand all" handler={() => this.grid.expandAll()}/>
                    <Button text="Collapse all" handler={() => this.grid.collapseAll()}/>
                </Toolbar>
            </PivotGrid>
        )
    }
