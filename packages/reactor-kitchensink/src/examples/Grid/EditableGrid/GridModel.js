export default Ext.define('EditableGridModel', {
    ...
    fields: [
        ...
        // Calculated field. Depends on price value. Adds it to price history. Trend
        // begins with the current price. Changes get pushed onto the end
        {
            name: 'trend',
            ...
            // It's the same array. But we need Model#set to see it as modified so it is
            // flushed to the UI
            isEqual: function () {
                return false;
            }
        ...
        // Calculated field, recalculated when price changes
        {
            ...
            type: 'date',
            calculate: function (data) {
                // Signal that we are dependent upon price so we get recaulculated when price
                // changes
                data.price;
