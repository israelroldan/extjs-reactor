...
export default function Home(props) {
    return (
        <Panel {...props} padding={30}>
            ...
            <p style={styles.p}>ExtReact is a powerful and comprehensive set of UI components for developing data-intensive enterprise applications using the <a target="_blank" href="https://facebook.github.io/react/">React</a> framework.</p>
